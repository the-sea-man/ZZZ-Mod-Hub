              ...
              <div className="flex flex-wrap items-center justify-between gap-3 p-4 rounded-xl bg-background/50 border border-white/5">
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-primary text-background font-bold rounded-xl hover:opacity-90 transition-all text-xs shadow-lg shadow-primary/20"
                  >
                    <Plus size={16} />
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-start justify-between mb-3">
                          <div>
                            <div className="flex items-center gap-2">
                              <span className="text-sm font-bold text-textMain">{lang.name}</span>
