...
Under **Settings > Card Appearance**, you can personalize the layout and visual styling of mod cards with a live interactive mock card preview:
...
3. Click **Generate Language Pack**.
...
- Adjust effect volume or mute sound effects anytime in **Settings > Audio**.
